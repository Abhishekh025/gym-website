...
<body>
    ...
    <section class="forms-section">
        <h1 class="section-title">Login/SignUp Form</h1>
        <div class="forms">
            ...
            <div class="form-wrapper">
                ...
                <form class="form form-signup"  action="logic.php" method="POST">
                    <fieldset>
                    ...
                    <button type="submit" name="data" class="btn-signup">Continue</button>
                </form>
            </div>
        </div>
    </section>
